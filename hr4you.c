...
void control_panel(char *line,worker *wo_arr,int *wo_num,FILE *out){
   ...
   while(token != NULL ) {
    ...
    /*printf("cmp str1 = %d str2 = %d\n",strcmp(str1,"Report"),strcmp(str2,"Workers"));*/
    if(strcmp(str1,"Add") == 0 && strcmp(str2,"Worker") == 0){                                                  /*[x]*/
        ...
        */
        ...
        /*printf("comp = %d\n",strcmp(str5,"Morning"));*/
        if(strcmp(str5,"Morning\r") == 0){
            time_of_day = MORNING;
        }
        else if(strcmp(str5,"Afternoon\r") == 0){
            time_of_day = AFTERNOON;
        }
        else if(strcmp(str5,"Evening\r") == 0){
            time_of_day = EVENING;
        }
        else if(strcmp(str5,"Night\r") == 0){
            time_of_day = NIGHT;
        }
        else{
        ...
        Add_Shift(wo_arr,*wo_num,id,day,time_of_day);
    }
    ...
    else if( ((strcmp(str1,"Report") == 0) && (strcmp(str2,"Workers") == 0)) ||
             ((strcmp(str1,"Report") == 0) && (strcmp(str2,"Workers\r") == 0)) ){
        int i;
        worker copy_arr[MAX_WORKERS];
        copy(wo_arr,copy_arr,*wo_num); 
        sort_array(copy_arr,*wo_num);

        if(strcmp(str3,"Bartender") == 0 || strcmp(str3,"Bartender\r") == 0 ){
            for(i = 0 ; i < *wo_num; i++){
        ...
        else if(strcmp(str3,"Waiter") == 0 || strcmp(str3,"Waiter\r") == 0){
            for(i = 0 ; i < *wo_num; i++){
        ...
        else if(strcmp(str3,"Manager") == 0 || strcmp(str3,"Manager\r") == 0){
            for(i = 0 ; i < *wo_num; i++){
        ...
        else if(strcmp(str3,"Cashier") == 0 || strcmp(str3,"Cashier\r") == 0 ){
            for(i = 0 ; i < *wo_num; i++){
        ...
        else if(strcmp(str3,"Chef") == 0 || strcmp(str3,"Chef\r") == 0){
            for(i = 0 ; i < *wo_num; i++){
        ...
        else if(strcmp(str3,"Dishwasher") == 0 || strcmp(str3,"Dishwasher\r") == 0){
            for(i = 0 ; i < *wo_num; i++){
        ...
        if(strcmp(str5,"Morning\r") == 0 || strcmp(str5,"Morning") == 0 ){
            time = MORNING;
        }
        else if(strcmp(str5,"Afternoon\r") == 0 || strcmp(str5,"Afternoon") == 0){
            time = AFTERNOON;
        }
        else if(strcmp(str5,"Evening\r") == 0 || strcmp(str5,"Evening") == 0){
            time = EVENING;
        }
        else if(strcmp(str5,"Night\r") == 0 || strcmp(str5,"Night") == 0){
            time = NIGHT;
        }
        else{
            prog2_report_error_message(INVALID_SHIFT_TYPE);
